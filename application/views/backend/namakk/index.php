        ...
        <form method="POST" action="<?= base_url('backend/namakk/edit') ?>" class="needs-validation" novalidate>
          ...
          <div class="modal-body">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" name="nik" id="nik" value="<?= $edit['nik'] ?>" placeholder="Enter nama KK">
              <div class="invalid-feedback">
            ...
            <div class="form-group mb-3">
              ...
              <input type="text" class="form-control" name="no_kk" id="no_kk" value="<?= $edit['no_kk'] ?>" placeholder="Enter nama KK">
              <div class="invalid-feedback">
